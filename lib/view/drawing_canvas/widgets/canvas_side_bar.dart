...
import 'package:lcsa_drawboard/main.dart';
...
import 'package:lcsa_drawboard/view/drawing_canvas/models/drawing_mode.dart';
import 'package:lcsa_drawboard/view/drawing_canvas/models/sketch.dart';
import 'package:lcsa_drawboard/view/drawing_canvas/widgets/color_palette.dart';
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Checkbox(
                  activeColor: Color.fromARGB(255, 1, 143, 117),
                  value: filled.value,
                  onChanged: (val) {
              ...
              child: drawingMode.value == DrawingMode.polygon
                  ? Row(
                      children: [
                        ...
                        Slider(
                          thumbColor: Color.fromARGB(255, 1, 143, 117),
                          activeColor: Color.fromARGB(255, 1, 143, 117),
                          inactiveColor: Color.fromARGB(30, 1, 143, 117),
                          secondaryActiveColor: Color.fromARGB(20, 1, 143, 117),
              ...
              children: [
                TextButton(
                  onPressed: allSketches.value.isNotEmpty
                      ...
                      : null,
                  child: const Text('Undo', style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                ),
                ValueListenableBuilder<bool>(
                  ...
                  builder: (_, canRedo, __) {
                    return TextButton(
                      ...
                      child: const Text('Redo', style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                    );
                  },
                ),
                TextButton(
                  child: const Text('Clear', style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                ...
                TextButton(
                  ...
                  child: Text(
                    backgroundImage.value == null
                        ? 'Add Background'
                        : 'Remove Background',
                        style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                ),
              ],
            ),
            const SizedBox(height: 20),
            ...
            Row(
              children: [
                SizedBox(
                  width: 140,
                  child: TextButton(
                    child: const Text('Export PNG', style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                    onPressed: () async {
                ...
                SizedBox(
                  width: 140,
                  child: TextButton(
                    child: const Text('Export JPEG', style: TextStyle(color: Color.fromARGB(255, 1, 143, 117))),
                    onPressed: () async {
                      Uint8List? pngBytes = await getBytes();
  ...
  void saveFile(Uint8List bytes, String extension) async {
    if (kIsWeb) {
      html.AnchorElement()
        ...
        ..download =
            'LCSA_Drawboard-${DateTime.now().toIso8601String()}.$extension'
        ..style.display = 'none'
        ..click();
    } else {
      await FileSaver.instance.saveFile(
        name: 'LCSA_Drawboard-${DateTime.now().toIso8601String()}.$extension',
        bytes: bytes,
        ext: extension,
